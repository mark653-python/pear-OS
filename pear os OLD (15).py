...
def open_icarly(e=None):
    # Launch directly into the iCarly vibe
...
def open_terminal(e=None):
    ...
    log_text = canvas.create_text(320, 210, text="\n".join(log), 
                                  anchor='nw', fill=data_cell_green, font=('Consolas', 11), tags=t)
    ...
    def process_command(event):
        ...
        if cmd == 'help':
            ...
            log.clear()
            log.append("Terminal cleared.")
        elif cmd == 'exit':
            close_window(t, 'Pear Command Prompt')
            return
        else:
...
def open_about(e=None):
    ...
    if t: 
        ...
        canvas.create_text(650, 420, text='Built With Python + Tkinter by mark chang', 
