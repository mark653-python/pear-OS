...
def open_settings(e=None):
    ...
    categories = ["Appearance", "Network", "System"]
    ...
    def show_category(cat):
        ...
        if cat == "Appearance":
            ...
            canvas.create_text(470, 230, text="Connection Info", font=('Segoe UI', 16, 'bold'), anchor='w', tags=(t, content_tags))
            canvas.create_text(470, 270, text="Wi-Fi: Connected (Gaia_5G)", font=('Segoe UI', 11), anchor='nw', tags=(t, content_tags))
        elif cat == "System":
            canvas.create_text(470, 230, text="GaiaSphere 1.0.4 HD", font=('Segoe UI', 16, 'bold'), anchor='w', tags=(t, content_tags))
...
def open_terminal(e=None):
    ...
    if not t: return
    log = ["GaiaCore Kernel v1.0.4 HD", "iCarly Mod: Online", "Type 'help' for commands."]
    ...
    def process(event):
        ...
        if cmd == 'help': log.append("help, clear, shooter, matrix, shake, party")
