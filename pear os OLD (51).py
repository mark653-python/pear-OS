...
# UPDATED: Interactive PearWeb Explorer
...
def open_snake(e=None):
    ...
    root.bind('<w>', lambda e: direction != 'Down' and set_dir('Up'))
    root.bind('<s>', lambda e: direction != 'Up' and set_dir('Down'))
    root.bind('<a>', lambda e: direction != 'Right' and set_dir('Left'))
    root.bind('<d>', lambda e: direction != 'Left' and set_dir('Right'))
    move()
